...
export const br33VolleyRifle: ItemEntry = {
  ...
  modelParts: {
    body: asset("items/models/weapons/br33/v001_Volley_rifle_default.glb"),
    sight: asset("items/models/weapons/br33/mod_mag_default.glb"),
    magazine: asset("items/models/weapons/br33/mod_sight_default.glb"),
    barrel: asset("items/models/weapons/br33/mod_barrel_default.glb"),
  },
  ...
  stats: [
    {
      ...
      max: 220,
      details: [
        { label: "Firepower", value: "20.7" },
        { label: "Damage", value: "14.8" },
        { label: "Precision", value: "1.4" },
        { label: "Rate of Fire", value: "900 RPM" },
      ],
    },
    {
      label: "Accuracy",
      ...
      max: 100,
      details: [
        { label: "Hipfire Spread", value: "2.20°" },
        { label: "ADS Spread", value: "0.96°" },
        { label: "Crouch Spread Bonus", value: "80.0%" },
        { label: "Moving Inaccuracy", value: "16.4%" },
      ],
    },
    {
      label: "Handling",
      ...
      details: [
        ...
        { label: "ADS Speed", value: "0.4S" },
        { label: "Weight", value: "28.0%" },
        { label: "Recoil", value: "87.3%" },
        { label: "Aim Assist", value: "1.61°" },
        { label: "Reload Speed", value: "3.0S" },
      ],
    },
    {
      label: "Range",
